...
import Fake.Primitives (elements, double, numeric)
...
cities =
  ...
  , "Austin", "Jacksonville", "Fort Worth", "Columbus", "Boston"
  , "Denver", "Washington", "Nashville", "Seattle", "Portland"
  , "Lagos", "Cairo", "Johannesburg", "Nairobi", "Accra"
  , "Addis Ababa", "Casablanca", "Tunis", "Kampala", "Harare"
  , "Gaborone", "Windhoek", "Dakar", "Abidjan", "Yaoundé"
  ]
...
countries =
  ...
  , "India", "Brazil", "Russia", "Australia", "South Korea"
  , "Netherlands", "Sweden", "Switzerland", "Norway", "Denmark"
  , "South Africa", "Nigeria", "Egypt", "Kenya", "Ghana"
  , "Ethiopia", "Morocco", "Tunisia", "Uganda", "Zimbabwe"
  , "Botswana", "Namibia", "Senegal", "Ivory Coast", "Cameroon"
  ]

countryCodes :: [String]
countryCodes =
  [ "US", "CA", "MX", "GB", "FR", "DE", "IT", "ES", "JP", "CN"
  , "IN", "BR", "RU", "AU", "KR", "NL", "SE", "CH", "NO", "DK"
  , "ZA", "NG", "EG", "KE", "GH", "ET", "MA", "TN", "UG", "ZW"
  , "BW", "NA", "SN", "CI", "CM"
  ]
